...
Assert(process.env.BASELINE_AWS_BUCKET, 'Missing env `BASELINE_AWS_BUCKET`')
Assert(process.env.BASELINE_AWS_REGION, 'Missing env `BASELINE_AWS_REGION`')
Assert(process.env.BASELINE_AWS_KEY, 'Missing env `BASELINE_AWS_KEY`')
Assert(process.env.BASELINE_AWS_SECRET, 'Missing env `BASELINE_AWS_SECRET`')
